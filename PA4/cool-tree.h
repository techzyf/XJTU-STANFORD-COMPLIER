...
private:
    virtual int check_inheritance_graph() = 0;
...
public:
    ...
    virtual void analyze() = 0;
    virtual Feature get_attr_node(char*) = 0;
    virtual Feature get_method_node(char*) = 0;
#ifdef Class__EXTRAS
    Class__EXTRAS
#endif
};
...
public:
    ...
    Symbol get_parent();
    void analyze();
    Feature get_attr_node(char*);
    Feature get_method_node(char*);
    Class_ copy_Class_();
    void dump(ostream& stream, int n);
